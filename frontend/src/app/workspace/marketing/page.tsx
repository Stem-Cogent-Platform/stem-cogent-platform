...
export default function MarketingCheckerPage() {
  ...
  async function check(event: React.FormEvent) {
    ...
    try { const value = await apiRequest<MarketingResult>("/api/v1/workspace/marketing/check", {method: "POST", body: JSON.stringify({copy, channel})}); setResult(value); setCheckedCopy(copy); }
