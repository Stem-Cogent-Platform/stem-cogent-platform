...
type Detail = { tenant: Row; readiness?: { ready: boolean; reason: string; company_briefs: number; meaningful_monitoring_count: number }; checklist: Record<string, boolean>; company_objects: Row[]; users: Row[]; invitations: Row[]; activations: Row[]; briefs: Row[] };
type Metrics = Row;
