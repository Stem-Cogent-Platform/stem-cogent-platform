...
output "vpc_endpoint_ids" {
  description = "Production VPC endpoint IDs keyed by logical AWS service name."
  value       = module.vpc.vpc_endpoint_ids
}

output "vpc_endpoint_security_group_id" {
  description = "Security group ID protecting the production AWS interface endpoints."
  value       = module.vpc.vpc_endpoint_security_group_id
}

output "ecs_cluster_name" {
  description = "Name of the production ECS Fargate cluster."
  value       = module.ecs.cluster_name
}

output "ecs_cluster_arn" {
  description = "ARN of the production ECS Fargate cluster."
  value       = module.ecs.cluster_arn
}

output "ecr_repository_names" {
  description = "Production ECR repository names keyed by api, worker, and frontend."
  value       = module.ecr.repository_names
}

output "ecr_repository_arns" {
  description = "Production ECR repository ARNs keyed by api, worker, and frontend."
  value       = module.ecr.repository_arns
}

output "ecr_repository_urls" {
  description = "Production ECR repository URLs keyed by api, worker, and frontend."
  value       = module.ecr.repository_urls
}

output "application_cd_build_role_arn" {
  description = "Production GitHub OIDC role ARN for Application CD image builds."
  value       = module.iam.application_build_role_arn
}

output "application_cd_deploy_role_arn" {
  description = "Production GitHub OIDC role ARN for Application CD ECS deployments."
  value       = module.iam.application_deploy_role_arn
}

output "application_cd_oidc_subject" {
  description = "Exact GitHub OIDC subject trusted by the production Application CD roles."
