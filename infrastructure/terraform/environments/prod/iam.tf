module "iam" {
  ...
  github_deployment_ref      = "refs/heads/main"
}

output "ecs_task_role_arns" {
  description = "Dedicated production application task-role ARNs keyed by ECS service name."
  value       = module.iam.task_role_arns
}

output "ecs_execution_role_arns" {
  description = "Dedicated production ECS execution-role ARNs keyed by ECS service name."
