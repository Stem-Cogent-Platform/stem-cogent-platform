...
variables {
  ...
  secret_arns = {
    ...
    anthropic_api_key       = "arn:aws:secretsmanager:eu-west-1:123456789012:secret:sc/staging/llm/anthropic/api-key-a"
    sendgrid_api_key        = "arn:aws:secretsmanager:eu-west-1:123456789012:secret:sc/staging/email/sendgrid/api-key-a"
